...
describe('columnsInValue', () => {
  describe('keepModelName', () => {
    it('keepModelName', () => {
      const expectData = { aData: '1232', xx_data: '1232', b: 1212, c: { x: 1 }, d: true }
      ...
      const fData = new (dynamicModelBase({ a: { type: 'string' } }))({ a: 1, b: 323 })
      ...
      expect(data.getChangedData()).toEqual(
        expectData,
      )
    })
  })
