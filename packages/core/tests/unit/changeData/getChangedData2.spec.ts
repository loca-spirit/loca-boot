...
describe('getChangedData test2', () => {
  ...
  it('getChangedData()1 CLEAN_UNDEFINED', () => {
    ...
    const c = new Consumer({ id: 1, userName: 'shuai', consumerObject: { id: 1, message: 'message1', name: 'name1' } })
    c.id = undefined as any
    c.userName = null as any
    c.phoneNumber = undefined as any
    expect(c.getChangedData({
      emptyValue: null,
  ...
  it('getChangedData()1 CLEAN_UNDEFINED_AND_NULL empty #', () => {
    ...
    const c = new Consumer({ id: 2, userName: 'shuai', consumerObject: { id: 1, message: 'message1' } })
    c.id = '' as any
    c.userName = null as any
  ...
  it('getChangedData()1 CLEAN_UNDEFINED_AND_NULL', () => {
    ...
    const c = new Consumer({ id: 1, userName: 'shuai', consumerObject: { id: 1, message: 'message1' } })
    c.id = null as any
